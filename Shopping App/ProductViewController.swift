...
class ProductViewController: DetailViewController {
    ...
    func configureView(for product: Product, with price: Double) {
        ...
        self.productCategory.text = "Категория: " + product.category
        self.quantityLabel.text = "Кол-во: " + String(quantity)
    }
    ...
    @IBAction func addToCart(_ sender: UIButton) {
        ...
        showAlertMsg("Успешно!", message: "Добавлено в корзину!", time: 1)
